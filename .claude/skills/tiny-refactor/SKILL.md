---
name: tiny-refactor
description: Identify and implement one small safe refactoring in the kubeopencode codebase using static analysis
---
...
1. Run static analysis tools (see Step 0)
...
- Exit with "no safe refactoring found" (see below)
